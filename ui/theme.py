...
.robot-eyes { background: #17203c; color: #bffbff; border-radius: 17px; padding: .28rem .65rem; font-family: monospace; letter-spacing: .35rem; font-weight: 900; white-space: nowrap; }
...
.robot-body { width: 150px; height: 115px; border: 5px solid #232947; border-radius: 25px; display: flex; flex-direction: column; align-items: center; justify-content: center; box-shadow: inset 0 -12px 0 rgba(0,0,0,.08); }
