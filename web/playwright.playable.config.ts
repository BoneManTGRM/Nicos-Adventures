...
// Artwork and the 2D friends map have their own acceptance workflows and browser settings.
export default defineConfig({
  ...base, testMatch: ['**/playable-world.e2e.ts', '**/connected-world.e2e.ts'], testIgnore: [], retries: 0, workers: 1,
