...
describe("Monster Lab premium body portraits", () => {
  it("renders an atlas body with its permanent face treatment", () => {
    ...
    expect(html).toContain("Dragon preview");
  });

  it("keeps the Lizard Alien's face integrated into its approved body art", () => {
    const html = render("Lizard Alien");
    expect(html).toContain('data-monster-portrait-body="Lizard Alien"');
