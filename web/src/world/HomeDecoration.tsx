...
export function HomeDecoration({item}:{item:string}) {
  return <svg viewBox="0 0 120 100" aria-hidden="true" className="home-decoration-art">
    ...
    item === 'Star Window' ? <><path d="M27 87V43A33 33 0 0 1 93 43V87Z" fill="#223762" stroke="#d0b689" strokeWidth="7"/><path d="M60 23L64 37L78 40L64 44L60 59L56 44L42 40L56 37Z" fill="#ffe8a9"/><circle cx="78" cy="68" r="3" fill="#b8eded"/></> :
