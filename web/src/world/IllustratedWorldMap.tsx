...
export function IllustratedWorldMap({
  alt,
  description,
  ...
  return (
    <figure className="world-atlas-illustration" data-valley-status={dinosaurValleyAvailable ? "open" : "locked"}>
      <picture className="world-atlas-illustration__art" data-map-art="premium-storybook">
