...
export const WORLD_SECTIONS: WorldSection[] = [
  ...
  { id: "monster-lab", emoji: "👾", name: { en: "Monster Lab", "es-MX": "Laboratorio de monstruos" }, description: { en: "Make a monster friend with a personality of its own.", "es-MX": "Crea un amigo monstruo con su propia personalidad." } },
