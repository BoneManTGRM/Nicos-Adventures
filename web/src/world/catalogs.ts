...
export const WORLD_SECTIONS: WorldSection[] = [
  ...
  { id: "animal-forest", emoji: "🐾", name: { en: "Animal Forest", "es-MX": "Bosque animal" }, description: { en: "Explore real wildlife photos, habitats, facts, favorites, and field missions.", "es-MX": "Explora fotos reales de fauna, hábitats, datos, favoritos y misiones." } },
  ...
  { id: "game-arcade", emoji: "🕹️", name: { en: "Game Arcade", "es-MX": "Sala de juegos" }, description: { en: "Play six quick learning and memory games.", "es-MX": "Juega seis juegos rápidos de aprendizaje y memoria." } },
