      ...
      <svg className="monster-traits monster-traits--front" viewBox="0 0 520 520" aria-hidden="true">
        ...
        <g className="monster-face" transform={monsterAccessoryTransform("face", accessoryLayout.face)}>
          {robotVisor
            ...
            : sleepyEyes
              ? <g className="monster-eye monster-eye--carved">{[226, 294].map((position) => <g key={position}><path d={`M${position-20} 216Q${position} 204 ${position+20} 216`} fill="none" stroke="#163a46" strokeWidth="7" strokeLinecap="round"/><ellipse cx={position} cy="235" rx="18" ry="16" fill="#061923" stroke="#6fc8d2" strokeOpacity=".72" strokeWidth="4"/><ellipse cx={position} cy="236" rx="8" ry="10" fill={`url(#eye-${monster.id})`}/><circle cx={position-3} cy="231" r="3" fill="#fff" opacity=".82"/></g>)}</g>
        ...
        <g className="monster-mouth" transform={monsterAccessoryTransform("mouth", accessoryLayout.mouth)}>
          {faceTreatment === "sculpted-dragon"
            ...
            : faceTreatment === "carved-golem"
              ? <><path d="M236 319Q260 337 284 319" fill="none" stroke="#0a2530" strokeWidth="8" strokeLinecap="round"/><path d="M242 322Q260 333 278 322" fill="none" stroke="#75cad2" strokeOpacity=".52" strokeWidth="3" strokeLinecap="round"/></>
              : robotVisor
