...
export const KNOWLEDGE_CATALOG = {
  "entries": [
    ...
    {
      "answer": {
        "en": "Open Robo Lab to play BoltBot’s six polished movements: wave, fly, scan, repair, flash lights, and celebrate.",
        "es-MX": "Abre el Laboratorio Robot para probar los seis movimientos de BoltBot: saludar, volar, escanear, reparar, encender luces y celebrar."
      },
      "id": "robots",
      "keywords": {
        "en": [
    ...
    {
      "answer": {
        "en": "Monster Lab uses premium creature bodies with a smaller set of dependable visual controls for color, pattern, texture, wings, and tails. Visit saved monsters in their habitats to grow friendship.",
        "es-MX": "El Laboratorio de Monstruos usa cuerpos prémium con controles visuales confiables para color, patrón, textura, alas y colas. Visita los hábitats de tus monstruos guardados para aumentar la amistad."
      },
      "id": "monsters",
      "keywords": {
        "en": [
