...
const monsters = read("src/world/MonsterWorld.tsx") + read("src/world/MonsterWorkshop.tsx");
const arcade = read("src/world/Arcade.tsx") + read("src/world/ArcadeCollection.tsx");
