...
test("Living destinations keep their navigation without WebGL", async ({ page }, testInfo) => {
  ...
  const illustratedMap = atlas.locator('.world-atlas-fallback__art[data-map-art="premium-storybook"]');
  ...
  await expect(atlas.locator(".world-atlas-fallback")).toHaveAttribute("data-valley-status", "locked");
