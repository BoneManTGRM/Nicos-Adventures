...
BADGES: tuple[Badge, ...] = (
    ...
    Badge("wildlife_ranger", "Wildlife Ranger", "🦁", "Discover sixteen animals.", "animal_discoveries", 16),
    Badge("world_naturalist", "World Naturalist", "🌍", "Discover thirty animals.", "animal_discoveries", 30),
    ...
    Badge("first_expedition", "First Expedition", "🧭", "Complete an Animal Forest expedition.", "animal_expeditions", 1),
    Badge("expedition_leader", "Expedition Leader", "🥾", "Complete ten expeditions.", "animal_expeditions", 10),
    Badge("quiz_rookie", "Animal Quiz Rookie", "🧠", "Answer your first animal quiz correctly.", "animal_quiz_correct", 1),
    Badge("quiz_master", "Animal Quiz Master", "🏆", "Answer ten animal quizzes correctly.", "animal_quiz_correct", 10),
...
EVENT_REWARDS: dict[str, int] = {
    ...
    "animal_favorites": 1,
    "animal_expeditions": 2,
    "animal_quiz_correct": 2,
    "animal_quiz_attempts": 0,
    "custom_animals": 2,
    "monsters_built": 2,
    "robot_jobs": 1,
}
